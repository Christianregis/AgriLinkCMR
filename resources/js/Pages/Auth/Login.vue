<template>
    <main class="flex flex-col items-center justify-center min-h-screen p-4 antialiased bg-neutral-bg">
        <FlashMessage />
        <!-- Logo -->
        ...
        <!-- LOGIN CARD -->
        <div class="w-full max-w-md overflow-hidden bg-white border border-gray-100 shadow-xl rounded-2xl">
            <div class="p-8">
                ...
                <form @submit.prevent="handleLogin()" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input required type="email" v-model="form.email" placeholder="votre@email.com"
                    ...
                    <div>
                        <div class="flex justify-between mb-2">
                            ...
                            <Link :href="showForgotpPassword()"
                                class="text-sm font-medium text-brand-primary hover:underline">Oublié ?</Link>
                        </div>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-3 text-sm cursor-pointer text-neutral-muted">Se souvenir de
                            moi</label>
                    </div>

                    <button type="submit" :disabled="form.processing"
                        class="w-full bg-brand-primary text-white py-3.5 rounded-xl font-bold hover:bg-brand-hover transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-3 disabled:opacity-80 disabled:cursor-not-allowed">
            ...
            <div class="p-6 text-center border-t border-gray-100 bg-brand-bg/50">
                <p class="text-sm text-neutral-body">
                    ...
                    <Link :href="inscription()" class="font-bold text-brand-primary hover:underline">Créer un compte
                    </Link>
                </p>
            </div>
        </div>
