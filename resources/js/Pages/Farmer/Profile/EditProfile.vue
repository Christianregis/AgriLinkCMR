                        ...
                        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="px-8 pb-8 flex flex-col md:flex-row items-end -mt-12 gap-6">
                                <div class="relative group">
                                    <img :src="form.profile_photo_preview || user.profile_photo_url || `https://ui-avatars.com/api/?name=${user.name}&background=2D6A4F&color=fff`"
                                ...
                                <div class="flex gap-4 pb-2">
                                    <div class="text-center px-6 border-r border-gray-100">
                                        ...
                                        <p class="text-[10px] font-bold text-neutral-muted uppercase tracking-widest">
                                            Note Moyenne</p>
                                    </div>
                            ...
                            <div class="lg:col-span-2 space-y-8">
                                ...
                                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                        <div>
                                            <label class="block mb-2 text-sm font-semibold text-neutral-title">Nom
                                                complet</label>
                                        ...
                                        <div>
                                            <label
                                                class="block mb-2 text-sm font-semibold text-neutral-title">Téléphone</label>
                                    ...
                                    <div>
                                        <label class="block mb-2 text-sm font-semibold text-neutral-title">Adresse
                                            Email</label>
                                ...
                                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                                    ...
                                    <p v-if="form.errors.bio" class="mt-1 text-sm text-red-500">{{ form.errors.bio }}
                                    </p>
                                </div>
