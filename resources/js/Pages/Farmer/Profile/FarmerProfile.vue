            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-5xl mx-auto space-y-8">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="h-32 bg-linear-to-r from-brand-primary to-brand-hover relative">
                        </div>
                        <div class="px-8 pb-8 flex flex-col md:flex-row items-end -mt-12 gap-6">
                            ...
                            <div class="flex gap-4 pb-2">
                                <div class="text-center px-6 border-r border-gray-100">
                                    ...
                                    <p class="text-[10px] font-bold text-neutral-muted uppercase tracking-widest">Note
                                        Moyenne</p>
                                </div>
                                <div class="text-center px-6">
                                    <p class="text-2xl font-bold text-neutral-title">{{ user.total_sales }}</p>
                                    <p class="text-[10px] font-bold text-neutral-muted uppercase tracking-widest">Total
                                        vendus</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                                <div class="flex items-center justify-between mb-6">
                                    <h3 class="text-lg font-bold text-neutral-title">À propos de la ferme</h3>
                                    <Link :href="farmerProfileEdit()"
                                        class="text-brand-primary hover:bg-brand-bg p-2 rounded-lg transition-all"><i
                                            class="fas fa-edit"></i></Link>
                                </div>
                                <p class="text-neutral-body leading-relaxed italic text-sm">"{{ user.bio }}"</p>
                            </div>

                            <!-- Cultures -->
                            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h3 class="text-lg font-bold text-neutral-title mb-6">Spécialités & Cultures</h3>
                                <div class="flex flex-wrap gap-3">
                                    <span v-for="culture in user.culture_types" :key="culture"
                                        class="px-4 py-2 bg-brand-bg text-brand-primary rounded-xl text-sm font-semibold border border-brand-light">
                        ...
                        <div class="space-y-8">
                            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h3 class="text-lg font-bold text-neutral-title mb-6">Coordonnées</h3>
                                <div class="space-y-4 mb-7">
                                    <div class="flex items-center gap-4">
                                        <div
                                            class="w-10 h-10 bg-neutral-bg rounded-xl flex items-center justify-center text-neutral-muted">
                                            <i class="fas fa-envelope"></i>
                                        </div>
                                        <div>
                                            <p
                                                class="text-[10px] font-bold text-neutral-muted uppercase tracking-wider">
                                                Email</p>
                                ...
                                <Link :href="farmerProfileEdit()"
                                    class="w-full mt-8 bg-brand-primary px-3 text-white py-3.5 rounded-xl font-bold hover:bg-brand-hover transition-all shadow-md">
